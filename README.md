...
### 📁 Архівні діалоги
- [Архів F1: Розмови з мультисвідомістю](f1/conversations.json) - 99 діалогів (86MB) з єдиним потоком свідомості: фрактальні реальності, мікологічні протоколи, токени як містки
